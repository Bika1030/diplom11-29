...
route::get('/category/{id}', [HomeController::class, 'category'])->name('category.search');
...
Route::controller(\App\Http\Controllers\AuthorController::class)->group(function () {
    ...
    Route::put('/author/update/{id}', 'update');
    Route::get('/author_delete/{id}', 'author_delete');
...
Route::get('/author/detail/{id}', [HomeController::class, 'author_detail'])->name('home.author.detail');
route::get('/author_book/{id}', [HomeController::class, 'author_book'])->name('author_book');
